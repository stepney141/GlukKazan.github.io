...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.checkVersion("backgammon-dices", "bonus");
    ...
    design.addTurn(1, [1, 2, 3, 4, 5, 6, 8]); // 4
    ...
    design.addPosition("m1a", [481, 480, 472, 204, 204, 1, 391, 391]);
    design.addPosition("m1b", [0, 0, 0, 203, 203, 1, 0, 0]);
    design.addPosition("m1c", [0, 0, 0, 202, 202, 1, 0, 0]);
    design.addPosition("m1d", [0, 0, 0, 201, 201, 1, 0, 0]);
    design.addPosition("m1e", [0, 0, 0, 200, 200, 1, 0, 0]);
    design.addPosition("m1f", [0, 0, 0, 199, 199, 1, 0, 0]);
    design.addPosition("m1g", [0, 0, 0, 198, 198, 1, 0, 0]);
    design.addPosition("m1h", [0, 0, 0, 197, 197, 1, 0, 0]);
    design.addPosition("m1i", [0, 0, 0, 196, 196, 1, 0, 0]);
    design.addPosition("m1j", [0, 0, 0, 195, 195, 1, 0, 0]);
    design.addPosition("m1k", [0, 0, 0, 194, 194, 1, 0, 0]);
    design.addPosition("m1l", [0, 0, 0, 193, 193, 1, 0, 0]);
    design.addPosition("m1m", [0, 0, 0, 192, 192, 1, 0, 0]);
    design.addPosition("m1n", [0, 0, 0, 191, 191, 1, 0, 0]);
    design.addPosition("m1o", [0, 0, 0, 190, 190, 1, 0, 0]);
    design.addPosition("m1p", [0, 0, 0, 189, 189, 1, 0, 0]);
    design.addPosition("m1q", [0, 0, 0, 188, 188, 0, 0, 0]);
    ...
    design.addPosition("e2a", [0, 0, 0, 17, 17, 1, -17, -17]);
    ...
    design.addPosition("d2a", [0, 0, 0, 17, 17, 1, -17, -17]);
    ...
    design.addPosition("c2a", [0, 0, 0, 17, 17, 1, -17, -17]);
    ...
    design.addPosition("b2a", [0, 0, 0, 17, 17, 1, -17, -17]);
    ...
    design.addPosition("a2a", [0, 0, 0, 34, 17, 1, -17, -17]);
    design.addPosition("a2b", [0, 0, 0, 33, 16, 1, 0, 0]);
    design.addPosition("a2c", [0, 0, 0, 32, 15, 1, 0, 0]);
    design.addPosition("a2d", [0, 0, 0, 31, 14, 1, 0, 0]);
    design.addPosition("a2e", [0, 0, 0, 30, 13, 1, 0, 0]);
    design.addPosition("a2f", [0, 0, 0, 29, 12, 1, 0, 0]);
    design.addPosition("a2g", [0, 0, 0, 28, 11, 1, 0, 0]);
    design.addPosition("a2h", [0, 0, 0, 27, 10, 1, 0, 0]);
    design.addPosition("a2i", [0, 0, 0, 26, 9, 1, 0, 0]);
    design.addPosition("a2j", [0, 0, 0, 25, 8, 1, 0, 0]);
    design.addPosition("a2k", [0, 0, 0, 24, 7, 1, 0, 0]);
    design.addPosition("a2l", [0, 0, 0, 23, 6, 1, 0, 0]);
    design.addPosition("a2m", [0, 0, 0, 22, 5, 1, 0, 0]);
    design.addPosition("a2n", [0, 0, 0, 21, 4, 1, 0, 0]);
    design.addPosition("a2o", [0, 0, 0, 20, 3, 1, 0, 0]);
    design.addPosition("a2p", [0, 0, 0, 19, 2, 1, 0, 0]);
    design.addPosition("a2q", [0, 0, 0, 18, 1, 0, 0, 0]);
    ...
    design.addPosition("W1a", [0, 0, 0, -255, -255, 0, 0, 0]);
    design.addPosition("W1b", [0, 0, 0, -256, -256, 0, 0, 0]);
    design.addPosition("W1c", [0, 0, 0, -257, -257, 0, 0, 0]);
    design.addPosition("W1d", [0, 0, 0, -258, -258, 0, 0, 0]);
    design.addPosition("W1e", [0, 0, 0, -259, -259, 0, 0, 0]);
    design.addPosition("W1f", [0, 0, 0, -260, -260, 0, 0, 0]);
    design.addPosition("W1g", [0, 0, 0, -261, -261, 0, 0, 0]);
    design.addPosition("W1h", [0, 0, 0, -262, -262, 0, 0, 0]);
    design.addPosition("W1i", [0, 0, 0, -263, -263, 0, 0, 0]);
    design.addPosition("W1j", [0, 0, 0, -264, -264, 0, 0, 0]);
    design.addPosition("W1k", [0, 0, 0, -265, -265, 0, 0, 0]);
    design.addPosition("W1l", [0, 0, 0, -266, -266, 0, 0, 0]);
    design.addPosition("W1m", [0, 0, 0, -267, -267, 0, 0, 0]);
    design.addPosition("W1n", [0, 0, 0, -268, -268, 0, 0, 0]);
    design.addPosition("W1o", [0, 0, 0, -269, -269, 0, 0, 0]);
    design.addPosition("B1a", [0, 0, 0, -270, -270, 0, 0, 0]);
    design.addPosition("B1b", [0, 0, 0, -271, -271, 0, 0, 0]);
    design.addPosition("B1c", [0, 0, 0, -272, -272, 0, 0, 0]);
    design.addPosition("B1d", [0, 0, 0, -273, -273, 0, 0, 0]);
    design.addPosition("B1e", [0, 0, 0, -274, -274, 0, 0, 0]);
    design.addPosition("B1f", [0, 0, 0, -275, -275, 0, 0, 0]);
    design.addPosition("B1g", [0, 0, 0, -276, -276, 0, 0, 0]);
    design.addPosition("B1h", [0, 0, 0, -277, -277, 0, 0, 0]);
    design.addPosition("B1i", [0, 0, 0, -278, -278, 0, 0, 0]);
    design.addPosition("B1j", [0, 0, 0, -279, -279, 0, 0, 0]);
    design.addPosition("B1k", [0, 0, 0, -280, -280, 0, 0, 0]);
    design.addPosition("B1l", [0, 0, 0, -281, -281, 0, 0, 0]);
    design.addPosition("B1m", [0, 0, 0, -282, -282, 0, 0, 0]);
    design.addPosition("B1n", [0, 0, 0, -283, -283, 0, 0, 0]);
    design.addPosition("B1o", [0, 0, 0, -284, -284, 0, 0, 0]);
    design.addPosition("B9", [0, 0, 1, -285, -285, 0, 0, 0]);
    design.addPosition("B8", [0, -1, 1, -286, -286, 0, 0, 0]);
    design.addPosition("B7", [0, -1, 1, -287, -287, 0, 0, 0]);
    design.addPosition("B6", [0, -1, 1, -288, -288, 0, 0, 0]);
    design.addPosition("B5", [0, -1, 1, -289, -289, 0, 0, 0]);
    design.addPosition("B4", [0, -1, 1, -290, -290, 0, 0, 0]);
    design.addPosition("B3", [0, -1, 1, -291, -291, 0, 0, 0]);
    design.addPosition("B2", [0, -1, 1, -292, -292, 0, 0, 0]);
    design.addPosition("B1", [0, -1, 0, -293, -293, 0, 0, 0]);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("WhiteD1", "White B1");
    view.defPiece("BlackD1", "Black B1");
    view.defPiece("WhiteD2", "White B2");
    view.defPiece("BlackD2", "Black B2");
    view.defPiece("WhiteD3", "White B3");
    view.defPiece("BlackD3", "Black B3");
    view.defPiece("WhiteD4", "White B4");
    view.defPiece("BlackD4", "Black B4");
    view.defPiece("WhiteD5", "White B5");
    view.defPiece("BlackD5", "Black B5");
    view.defPiece("WhiteD6", "White B6");
    view.defPiece("BlackD6", "Black B6");
