...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "Man", 0);
    design.setup("You", "Man", 1);
    design.setup("You", "Man", 2);
    design.setup("You", "Man", 8);
    design.setup("You", "Man", 9);
    design.setup("You", "Man", 10);
    design.setup("You", "Man", 16);
    design.setup("You", "Man", 17);
