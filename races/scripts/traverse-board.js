...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.reserve("West", "S", 2);
    design.reserve("West", "T", 2);
    design.reserve("West", "R", 2);
    design.reserve("West", "C", 2);

    design.reserve("North", "S", 2);
    design.reserve("North", "T", 2);
    design.reserve("North", "R", 2);
    design.reserve("North", "C", 2);

    design.reserve("East", "S", 2);
    design.reserve("East", "T", 2);
    design.reserve("East", "R", 2);
    design.reserve("East", "C", 2);
}
