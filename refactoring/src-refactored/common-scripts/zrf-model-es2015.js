{
  ...
  class ZrfDesign {
    ...
    addMove(type, template, params, mode, sound) {
    ...
    addDrop(type, template, params, mode, sound) {
      if (_.isUndefined(this.pieces[type])) {
        this.pieces[type] = [];
      }
      if (!_.isUndefined(this.templates[template])) {
