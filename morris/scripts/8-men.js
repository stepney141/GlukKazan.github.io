...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("B7", [0, 1, 0, 9]);
    design.addPosition("C7", [0, 1, -1, 3]);
    design.addPosition("D7", [0, 0, -1, 5]);
    design.addPosition("A6", [0, 1, 0, 3]);
    design.addPosition("C6", [-3, 1, -1, 14]);
    design.addPosition("E6", [0, 0, -1, 8]);
    design.addPosition("A5", [-3, 1, 0, 6]);
    design.addPosition("D5", [-5, 1, -1, 3]);
    design.addPosition("G5", [0, 0, -1, 6]);
    design.addPosition("B4", [-9, 1, 0, 6]);
    design.addPosition("D4", [-3, 1, -1, 0]);
    design.addPosition("F4", [0, 0, -1, 6]);
    design.addPosition("A3", [-6, 1, 0, 0]);
    design.addPosition("E3", [-8, 1, -1, 3]);
    design.addPosition("G3", [-6, 0, -1, 6]);
    design.addPosition("B2", [-6, 1, 0, 0]);
    design.addPosition("E2", [-3, 1, -1, 0]);
    design.addPosition("F2", [-6, 0, -1, 2]);
    design.addPosition("C1", [-14, 1, 0, 0]);
    design.addPosition("F1", [-2, 1, -1, 0]);
    design.addPosition("G1", [-6, 0, -1, 0]);
