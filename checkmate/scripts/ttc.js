...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a8", 25, 25, 60, 60);
    view.defPosition("b8", 85, 25, 60, 60);
    view.defPosition("c8", 145, 25, 60, 60);
    view.defPosition("d8", 205, 25, 60, 60);
    view.defPosition("e8", 265, 25, 60, 60);
    view.defPosition("f8", 325, 25, 60, 60);
    view.defPosition("g8", 385, 25, 60, 60);
    view.defPosition("h8", 445, 25, 60, 60);
    view.defPosition("a7", 25, 85, 60, 60);
    view.defPosition("b7", 85, 85, 60, 60);
    view.defPosition("c7", 145, 85, 60, 60);
    view.defPosition("d7", 205, 85, 60, 60);
    view.defPosition("e7", 265, 85, 60, 60);
    view.defPosition("f7", 325, 85, 60, 60);
    view.defPosition("g7", 385, 85, 60, 60);
    view.defPosition("h7", 445, 85, 60, 60);
    view.defPosition("a6", 25, 145, 60, 60);
    view.defPosition("b6", 85, 145, 60, 60);
    view.defPosition("c6", 145, 145, 60, 60);
    view.defPosition("d6", 205, 145, 60, 60);
    view.defPosition("e6", 265, 145, 60, 60);
    view.defPosition("f6", 325, 145, 60, 60);
    view.defPosition("g6", 385, 145, 60, 60);
    view.defPosition("h6", 445, 145, 60, 60);
    view.defPosition("a5", 25, 205, 60, 60);
    view.defPosition("b5", 85, 205, 60, 60);
    view.defPosition("c5", 145, 205, 60, 60);
    view.defPosition("d5", 205, 205, 60, 60);
    view.defPosition("e5", 265, 205, 60, 60);
    view.defPosition("f5", 325, 205, 60, 60);
    view.defPosition("g5", 385, 205, 60, 60);
    view.defPosition("h5", 445, 205, 60, 60);
    view.defPosition("a4", 25, 265, 60, 60);
    view.defPosition("b4", 85, 265, 60, 60);
    view.defPosition("c4", 145, 265, 60, 60);
    view.defPosition("d4", 205, 265, 60, 60);
    view.defPosition("e4", 265, 265, 60, 60);
    view.defPosition("f4", 325, 265, 60, 60);
    view.defPosition("g4", 385, 265, 60, 60);
    view.defPosition("h4", 445, 265, 60, 60);
    view.defPosition("a3", 25, 325, 60, 60);
    view.defPosition("b3", 85, 325, 60, 60);
    view.defPosition("c3", 145, 325, 60, 60);
    view.defPosition("d3", 205, 325, 60, 60);
    view.defPosition("e3", 265, 325, 60, 60);
    view.defPosition("f3", 325, 325, 60, 60);
    view.defPosition("g3", 385, 325, 60, 60);
    view.defPosition("h3", 445, 325, 60, 60);
    view.defPosition("a2", 25, 385, 60, 60);
    view.defPosition("b2", 85, 385, 60, 60);
    view.defPosition("c2", 145, 385, 60, 60);
    view.defPosition("d2", 205, 385, 60, 60);
    view.defPosition("e2", 265, 385, 60, 60);
    view.defPosition("f2", 325, 385, 60, 60);
    view.defPosition("g2", 385, 385, 60, 60);
    view.defPosition("h2", 445, 385, 60, 60);
    view.defPosition("a1", 25, 445, 60, 60);
    view.defPosition("b1", 85, 445, 60, 60);
    view.defPosition("c1", 145, 445, 60, 60);
    view.defPosition("d1", 205, 445, 60, 60);
    view.defPosition("e1", 265, 445, 60, 60);
    view.defPosition("f1", 325, 445, 60, 60);
    view.defPosition("g1", 385, 445, 60, 60);
    view.defPosition("h1", 445, 445, 60, 60);
}
