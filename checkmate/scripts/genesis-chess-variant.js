...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(0, 4, [1, 4, 4], 1);
    design.addMove(0, 4, [0, 4, 4], 1);

    design.addPiece("Knight", 1, 320);
    design.addDrop(1, 0, [], 1);
    design.addMove(1, 5, [4, 7], 1);
    design.addMove(1, 5, [4, 3], 1);
    design.addMove(1, 5, [2, 6], 1);
    design.addMove(1, 5, [2, 5], 1);
    design.addMove(1, 5, [0, 7], 1);
    design.addMove(1, 5, [0, 6], 1);
    design.addMove(1, 5, [1, 3], 1);
    design.addMove(1, 5, [1, 5], 1);

    design.addPiece("Bishop", 2, 330);
    design.addDrop(2, 0, [], 1);
    design.addMove(2, 6, [7, 7], 1);
    design.addMove(2, 6, [6, 6], 1);
    design.addMove(2, 6, [3, 3], 1);
    design.addMove(2, 6, [5, 5], 1);

    design.addPiece("Rook", 3, 500);
    design.addDrop(3, 0, [], 1);
    design.addMove(3, 6, [4, 4], 1);
    design.addMove(3, 6, [2, 2], 1);
    design.addMove(3, 6, [0, 0], 1);
    design.addMove(3, 6, [1, 1], 1);

    design.addPiece("Queen", 4, 900);
    design.addDrop(4, 0, [], 1);
    design.addMove(4, 6, [4, 4], 1);
    design.addMove(4, 6, [2, 2], 1);
    design.addMove(4, 6, [0, 0], 1);
    design.addMove(4, 6, [1, 1], 1);
    design.addMove(4, 6, [7, 7], 1);
    design.addMove(4, 6, [6, 6], 1);
    design.addMove(4, 6, [3, 3], 1);
    design.addMove(4, 6, [5, 5], 1);

    design.addPiece("King", 5, 20000);
    design.addDrop(5, 0, [], 0);
    design.addMove(5, 7, [4], 1);
    design.addMove(5, 7, [2], 1);
    design.addMove(5, 7, [0], 1);
    design.addMove(5, 7, [1], 1);
    design.addMove(5, 7, [7], 1);
    design.addMove(5, 7, [6], 1);
    design.addMove(5, 7, [3], 1);
    design.addMove(5, 7, [5], 1);
    design.addMove(5, 8, [1, 1, 1, 0, 0], 1);
    design.addMove(5, 9, [0, 0, 0, 0, 1, 1, 1], 1);
