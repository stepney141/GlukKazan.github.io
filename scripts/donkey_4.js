...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00101", 3);
    design.setup("You", "B00011", 7);
    design.setup("You", "R0110F2", 1);
    design.setup("You", "R1010F2", 2);
    design.setup("You", "R0101F2", 5);
    design.setup("You", "R1001F2", 6);
    design.setup("You", "B00103", 12);
    design.setup("You", "B00013", 16);
    design.setup("You", "B00104", 10);
    design.setup("You", "B00014", 14);
    ...
    design.setup("You", "B00008", 4);
    design.setup("You", "B00009", 13);
