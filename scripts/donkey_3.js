...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00011", 6);
    design.setup("You", "R0110F2", 0);
    design.setup("You", "R1010F2", 1);
    design.setup("You", "R0101F2", 4);
    design.setup("You", "R1001F2", 5);
    design.setup("You", "B00103", 9);
    design.setup("You", "B00013", 13);
    ...
    design.setup("You", "B00007", 7);
    design.setup("You", "B00008", 8);
