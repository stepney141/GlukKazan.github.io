...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00101", 4);
    design.setup("You", "B00011", 8);
    design.setup("You", "R0110F2", 12);
    design.setup("You", "R1010F2", 13);
    design.setup("You", "R0101F2", 16);
    design.setup("You", "R1001F2", 17);
    design.setup("You", "B00103", 5);
    design.setup("You", "B00013", 9);
    design.setup("You", "B00104", 2);
    design.setup("You", "B00014", 6);
    design.setup("You", "B01005", 14);
    design.setup("You", "B10005", 15);
    design.setup("You", "B00106", 3);
    design.setup("You", "B00016", 7);
    design.setup("You", "B00007", 0);
    design.setup("You", "B00008", 1);
    design.setup("You", "B00009", 10);
    design.setup("You", "B000010", 11);
