...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "B00101", 1);
    design.setup("You", "B00011", 5);
    design.setup("You", "R0110F2", 6);
    design.setup("You", "R1010F2", 7);
    design.setup("You", "R0101F2", 10);
    design.setup("You", "R1001F2", 11);
    design.setup("You", "B00103", 4);
    design.setup("You", "B00013", 8);
    design.setup("You", "B00104", 12);
    design.setup("You", "B00014", 16);
    design.setup("You", "B01005", 13);
    design.setup("You", "B10005", 14);
    design.setup("You", "B00106", 15);
    design.setup("You", "B00016", 19);
    design.setup("You", "B00007", 0);
    design.setup("You", "B00008", 9);
    design.setup("You", "B00009", 2);
    design.setup("You", "B000010", 3);
