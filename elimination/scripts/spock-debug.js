...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Blue", "Rock", 11);
    design.setup("Blue", "Rock", 17);
    design.setup("Blue", "Rock", 18);
    design.setup("Blue", "Rock", 19);
    design.setup("Blue", "Scissors", 15);
    design.setup("Blue", "Scissors", 21);
    design.setup("Blue", "Scissors", 22);
    design.setup("Blue", "Scissors", 23);
    design.setup("Blue", "Spock", 6);
    design.setup("Blue", "Paper", 10);
