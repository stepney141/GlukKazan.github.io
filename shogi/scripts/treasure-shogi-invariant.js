...
Dagaz.Model.checkVersion = function(design, name, value) {
  if (name != "treasure-shogi-invariant") {
...
Dagaz.Model.CheckInvariants = function(board) {
  ...
  _.each(board.moves, function(m) {
      ...
      if (isAttacked(design, b, board.player, pos, n, [king, gold, silver, sp, kp, lp], [lance]) ||
          isAttacked(design, b, board.player, pos, s, [king, gold, sp, kp, lp], []) ||
          isAttacked(design, b, board.player, pos, w, [king, gold, sp, kp, lp], []) ||
          isAttacked(design, b, board.player, pos, e, [king, gold, sp, kp, lp], []) ||
          isAttacked(design, b, board.player, pos, nw, [king, gold, silver, sp, kp, lp], []) ||
          isAttacked(design, b, board.player, pos, ne, [king, gold, silver, sp, kp, lp], []) ||
