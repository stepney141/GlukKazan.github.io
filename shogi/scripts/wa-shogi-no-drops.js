...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("Y11", [0, 17, 16, 0, -1, 0, 0, 0]);
    design.addPosition("M11", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("a11", [18, 17, 0, 1, 0, 0, 0, 0]);
    ...
    design.addPosition("k11", [0, 17, 16, 0, -1, 0, 0, 0]);
    design.addPosition("N11", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z11", [18, 17, 0, 1, 0, 0, 0, 0]);
    design.addPosition("T11", [0, 17, 16, 0, -1, 0, 0, 0]);
    design.addPosition("X10", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y10", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k10", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N10", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z10", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T10", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X9", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y9", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k9", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N9", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z9", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T9", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X8", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y8", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k8", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N8", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z8", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T8", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X7", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y7", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k7", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N7", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z7", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T7", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X6", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y6", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k6", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N6", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z6", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T6", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X5", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y5", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k5", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N5", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z5", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T5", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X4", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y4", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k4", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N4", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z4", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T4", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X3", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y3", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k3", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N3", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z3", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T3", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X2", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y2", [0, 17, 16, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k2", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("N2", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z2", [18, 17, 0, 1, 0, -16, 0, -17]);
    design.addPosition("T2", [0, 17, 16, 0, -1, 0, -18, -17]);
    design.addPosition("X1", [0, 0, 0, 1, 0, -16, 0, -17]);
    design.addPosition("Y1", [0, 0, 0, 0, -1, 0, -18, -17]);
    ...
    design.addPosition("k1", [0, 0, 0, 0, -1, 0, -18, -17]);
    design.addPosition("N1", [0, 0, 0, 0, 0, 0, 0, 0]);
    design.addPosition("Z1", [0, 0, 0, 1, 0, -16, 0, -17]);
    ...
    design.addPiece("ViolentStag", 4, 10);
    ...
    design.addPiece("FlyingGoose", 6, 8);
    ...
    design.addPiece("FlyingFalcon", 16, 42);
    ...
    design.addPiece("CloudEagle", 18, 40);
    ...
    design.addMove(19, 2, [6, 6], 0);
    design.addMove(19, 2, [5, 5], 0);
    design.addMove(19, 3, [6], 0);
    design.addMove(19, 3, [5], 0);

    design.addPiece("TreacherousFox", 20, 36);
    ...
    design.addMove(20, 4, [7, 7], 0);
    design.addMove(20, 4, [1, 1], 0);
    design.addMove(20, 4, [6, 6], 0);
    design.addMove(20, 4, [2, 2], 0);
    design.addMove(20, 4, [5, 5], 0);
    design.addMove(20, 4, [0, 0], 0);
    ...
    design.addMove(21, 4, [7, 7], 0);
    design.addMove(21, 4, [1, 1], 0);
    design.addMove(21, 4, [6, 6], 0);
    design.addMove(21, 4, [2, 2], 0);
    design.addMove(21, 4, [5, 5], 0);
    design.addMove(21, 4, [0, 0], 0);

    design.addPiece("RunningRabbit", 22, 20);
    ...
    design.addPiece("BearsEyes", 24, 16);
    ...
    design.addPiece("RoamingBoar", 25, 14);
    ...
    design.addPiece("RaidingFalcon", 26, 28);
    ...
    design.addPiece("GlidingSwallow", 27, 40);
    design.addMove(27, 1, [7, 7], 0);
    design.addMove(27, 1, [1, 1], 0);
    design.addMove(27, 1, [4, 4], 0);
    design.addMove(27, 1, [3, 3], 0);

    design.addPiece("HeavenlyHorse", 28, 16);
    design.addMove(28, 4, [7, 6], 0);
    design.addMove(28, 4, [7, 5], 0);
    design.addMove(28, 4, [1, 2], 0);
    design.addMove(28, 4, [1, 0], 0);

    design.addPiece("PloddingOx", 29, 16);
    ...
    design.addPiece("GoldenBird", 30, 12);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("SouthViolentWolfP", "South ViolentWolfP");
    view.defPiece("NorthViolentWolfP", "North ViolentWolfP");
    view.defPiece("SouthViolentStag", "South ViolentStag");
    view.defPiece("NorthViolentStag", "North ViolentStag");
    view.defPiece("SouthViolentStagP", "South ViolentStagP");
    view.defPiece("NorthViolentStagP", "North ViolentStagP");
    ...
    view.defPiece("SouthSwallowsWingsP", "South SwallowsWingsP");
    view.defPiece("NorthSwallowsWingsP", "North SwallowsWingsP");
    view.defPiece("SouthFlyingFalcon", "South FlyingFalcon");
    view.defPiece("NorthFlyingFalcon", "North FlyingFalcon");
    view.defPiece("SouthFlyingFalconP", "South FlyingFalconP");
    view.defPiece("NorthFlyingFalconP", "North FlyingFalconP");
    view.defPiece("SouthCloudEagle", "South CloudEagle");
    view.defPiece("NorthCloudEagle", "North CloudEagle");
    view.defPiece("SouthCloudEagleP", "South CloudEagleP");
    view.defPiece("NorthCloudEagleP", "North CloudEagleP");
    view.defPiece("SouthTreacherousFox", "South TreacherousFox");
    view.defPiece("NorthTreacherousFox", "North TreacherousFox");
    view.defPiece("SouthTreacherousFoxP", "South TreacherousFoxP");
    view.defPiece("NorthTreacherousFoxP", "North TreacherousFoxP");
    view.defPiece("SouthRunningRabbit", "South RunningRabbit");
    view.defPiece("NorthRunningRabbit", "North RunningRabbit");
    view.defPiece("SouthTenaciousFalcon", "South TenaciousFalcon");
    view.defPiece("NorthTenaciousFalcon", "North TenaciousFalcon");
    view.defPiece("SouthBearsEyes", "South BearsEyes");
    view.defPiece("NorthBearsEyes", "North BearsEyes");
    view.defPiece("SouthRoamingBoar", "South RoamingBoar");
    view.defPiece("NorthRoamingBoar", "North RoamingBoar");
    view.defPiece("SouthRaidingFalcon", "South RaidingFalcon");
    view.defPiece("NorthRaidingFalcon", "North RaidingFalcon");
    view.defPiece("SouthGlidingSwallow", "South GlidingSwallow");
    view.defPiece("NorthGlidingSwallow", "North GlidingSwallow");
    view.defPiece("SouthHeavenlyHorse", "South HeavenlyHorse");
    view.defPiece("NorthHeavenlyHorse", "North HeavenlyHorse");
    view.defPiece("SouthPloddingOx", "South PloddingOx");
    view.defPiece("NorthPloddingOx", "North PloddingOx");
    view.defPiece("SouthGoldenBird", "South GoldenBird");
    view.defPiece("NorthGoldenBird", "North GoldenBird");
