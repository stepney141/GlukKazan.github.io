...
Dagaz.Model.CheckInvariants = function(board) {
  ...
  _.each(board.moves, function(move) {
      if ((move.actions.length > 0) && (move.actions[0][0] !== null)) {
          ...
          if (isAttacked(design, b, board.player, king,  n, [0, 1, 2, 3, 4, 5, 6, 8, 9, 11, 14, 15, 16, 17, 20, 21, 24, 25, 29, 30], [12, 13, 18, 19, 22, 23, 26, 27]) ||
          ...
          if (isRangeAttacked(design, b, board.player, king,  s,  2, [13]) ||
              isRangeAttacked(design, b, board.player, king, nw,  2, [18, 19]) ||
              isRangeAttacked(design, b, board.player, king, ne,  2, [18, 19]) ||
              isRangeAttacked(design, b, board.player, king, nw,  3, [18, 19]) ||
              isRangeAttacked(design, b, board.player, king, ne,  3, [18, 19])) {
              move.failed = true;
              return;
          }
          if (isJumpAttacked(design, b, board.player, king,  n,  n, [20, 21]) ||
              isJumpAttacked(design, b, board.player, king,  s,  s, [20, 21]) ||
              isJumpAttacked(design, b, board.player, king, nw, nw, [20, 21]) ||
              isJumpAttacked(design, b, board.player, king, ne, ne, [20, 21]) ||
              isJumpAttacked(design, b, board.player, king, sw, sw, [20, 21]) ||
              isJumpAttacked(design, b, board.player, king, se, se, [20, 21]) ||
              isJumpAttacked(design, b, board.player, king,  n, nw, [28]) ||
              isJumpAttacked(design, b, board.player, king,  n, ne, [28]) ||
              isJumpAttacked(design, b, board.player, king,  s, sw, [28]) ||
              isJumpAttacked(design, b, board.player, king,  s, se, [28])) {
              move.failed = true;
              return;
          }
      }
